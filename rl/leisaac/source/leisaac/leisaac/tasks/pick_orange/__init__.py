...
gym.register(
    id="LeIsaac-SO101-PickOrange-Single-Direct-v0",
    entry_point=f"{__name__}.direct.pick_orange_single_env:PickOrangeSingleEnv",
    disable_env_checker=True,
    kwargs={
        "env_cfg_entry_point": f"{__name__}.direct.pick_orange_single_env:PickOrangeSingleEnvCfg",
        "rsl_rl_cfg_entry_point": f"{__name__}.agents:PickOrangeSinglePPORunnerCfg",
    },
)
