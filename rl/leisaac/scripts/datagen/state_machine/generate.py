...
from leisaac.datagen.state_machine import PickOrangeStateMachine, FoldClothStateMachine
...
TASK_REGISTRY = {
    ...
    "LeIsaac-SO101-FoldCloth-BiArm-Direct-v0": (FoldClothStateMachine, "bi_so101_state_machine"),
}
