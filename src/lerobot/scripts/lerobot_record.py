...
def record_loop(
    ...
    while timestamp < control_time_s:
        ...
        # Teleoperators with their own event source (e.g. VR controllers)
        if isinstance(teleop, Teleoperator) and hasattr(teleop, "update_events"):
            teleop.update_events(events)
        ...
        if isinstance(teleop, Teleoperator):
            # Teleoperators that need robot feedback (e.g. VR with joint-space P-control)
